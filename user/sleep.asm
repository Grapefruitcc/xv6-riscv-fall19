...
int main(int argc, char *argv[]) {
  ...
  14:	1c2080e7          	jalr	450(ra) # 1d2 <atoi>
	...
	if (argc != 2) {
  18:	4789                	li	a5,2
  1a:	00f48f63          	beq	s1,a5,38 <main+0x38>
		printf("error:argument error.require 1\n");
  1e:	00000517          	auipc	a0,0x0
  22:	7da50513          	addi	a0,a0,2010 # 7f8 <malloc+0xec>
  26:	00000097          	auipc	ra,0x0
  2a:	628080e7          	jalr	1576(ra) # 64e <printf>
		exit(1);
  2e:	4505                	li	a0,1
  30:	00000097          	auipc	ra,0x0
  34:	29e080e7          	jalr	670(ra) # 2ce <exit>
  38:	892a                	mv	s2,a0
	}
	printf("success:sleep for %d\n", sleep_time);
  3a:	85aa                	mv	a1,a0
  3c:	00000517          	auipc	a0,0x0
  40:	7dc50513          	addi	a0,a0,2012 # 818 <malloc+0x10c>
  44:	00000097          	auipc	ra,0x0
  48:	60a080e7          	jalr	1546(ra) # 64e <printf>
	sleep(sleep_time);
  4c:	854a                	mv	a0,s2
  4e:	00000097          	auipc	ra,0x0
  52:	310080e7          	jalr	784(ra) # 35e <sleep>
	exit(0);
  56:	4501                	li	a0,0
  58:	00000097          	auipc	ra,0x0
  5c:	276080e7          	jalr	630(ra) # 2ce <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	47e50513          	addi	a0,a0,1150 # 838 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	3b2b8b93          	addi	s7,s7,946 # 838 <digits>
 ...
 5ca:	26a90913          	addi	s2,s2,618 # 830 <malloc+0x124>
        while(*s != 0){
...
free(void *ap)
{
 ...
 692:	1c27b783          	ld	a5,450(a5) # 850 <freep>
 ...
 6c0:	00e6ea63          	bltu	a3,a4,6d4 <free+0x50>
{
 ...
 702:	14f73923          	sd	a5,338(a4) # 850 <freep>
}
 706:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 734:	12053503          	ld	a0,288(a0) # 850 <freep>
 ...
 75c:	0f890913          	addi	s2,s2,248 # 850 <freep>
  if(p == (char*)-1)
 760:	5afd                	li	s5,-1
 762:	a895                	j	7d6 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 764:	00000797          	auipc	a5,0x0
 768:	0f478793          	addi	a5,a5,244 # 858 <base>
 76c:	00000717          	auipc	a4,0x0
 770:	0ef73223          	sd	a5,228(a4) # 850 <freep>
 774:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 798:	0aa73e23          	sd	a0,188(a4) # 850 <freep>
      return (void*)(p + 1);
