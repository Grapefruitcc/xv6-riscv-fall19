...
main(int argc, char *argv[])
{
  ...
  4c:	24a080e7          	jalr	586(ra) # 292 <write>
    if(i + 1 < argc){
  ...
  60:	236080e7          	jalr	566(ra) # 292 <write>
  for(i = 1; i < argc; i++){
  ...
  76:	220080e7          	jalr	544(ra) # 292 <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
  7c:	00000097          	auipc	ra,0x0
  80:	1f6080e7          	jalr	502(ra) # 272 <exit>
...
gets(char *buf, int max)
{
 ...
 172:	11c080e7          	jalr	284(ra) # 28a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	0f2080e7          	jalr	242(ra) # 2b2 <open>
  if(fd < 0)
 ...
 1d4:	0fa080e7          	jalr	250(ra) # 2ca <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	00000097          	auipc	ra,0x0
 1e0:	0be080e7          	jalr	190(ra) # 29a <close>
  return r;
}
 1e4:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
 ...
 348:	f4e080e7          	jalr	-178(ra) # 292 <write>
}
...
malloc(uint nbytes)
{
 ...
 7a2:	b5c080e7          	jalr	-1188(ra) # 2fa <sbrk>
  if(p == (char*)-1)
